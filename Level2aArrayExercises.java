...
public class Level2aArrayExercises {
    ...
    public static void findMax(int[] arr, int numSize){
        ...
        //display maximum
        System.out.print("The maxnimum number you've entered is: " + maxN);
        //display occurence of maximum
        int counter = 0;
        for(int i=0; i<numSize; i++){//for loop through every number user entered
            if(maxN == arr[i]){//increase counter to display occurences of max number
                counter++;
            }
        }
        System.out.println("      # of occurrences is " + counter);
    }
    ...
    public static void findMin(int[] arr, int numSize){
        ...
        //display minimum
        System.out.print("The minimum number you've entered is: " + minN);
        //display occurence of minimum
        int counter = 0;
        for(int i=0; i<numSize; i++){//for loop through every number user entered
            if(minN == arr[i]){//increase counter to display occurences of min number
                counter++;
            }
        }
        System.out.println("      # of occurrences is " + counter);
